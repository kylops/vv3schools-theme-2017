...
var STORAGE_KEY = 'vv3-theme';
var siteInfoStorage = {
    fetch: function fetch() {
        var siteInfo = JSON.parse(localStorage.getItem(STORAGE_KEY) || '{}');
        return siteInfo;
    },
...
var mutations = {
    ...
    // },
    updateAllPosts: function updateAllPosts(state, posts) {
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/Kyle/Sites/vv3schools/wp-content/themes/vv3schools-theme-2017/assets/js/components/_site-nav.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
var _uikit = __webpack_require__(16);

var _uikit2 = _interopRequireDefault(_uikit);

var _uikitIcons = __webpack_require__(15);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1caecbee&file=_site-nav.vue!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./_site-nav.vue", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1caecbee&file=_site-nav.vue!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./_site-nav.vue");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7377ef7d&file=Home.vue!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Home.vue", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7377ef7d&file=Home.vue!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Home.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
